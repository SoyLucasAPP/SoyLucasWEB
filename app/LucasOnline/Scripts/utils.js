...
// └────────────────────────────────────────────────────────────────────┘ \\
var URL = {
    BASE: 'http://localhost:81/SoyLucas',
    INICIO: 'http://200.60.88.242:8022/Inicio'
}
...
function pintaConsola() {
    ...
    log.l('%ccopiaras y pegaras algo aquí para habilitar una funcion de Soy Lucas o para  ', codeStyle);
    log.l('%c"hackear" la cuenta de alguien, se trata de un fraude. Si lo haces esta      ', codeStyle);
    log.l('%cpersona podrá acceder a tu cuenta.                                           ', codeStyle);
}
